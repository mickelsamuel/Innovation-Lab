        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          <div className="text-center">
            <div className="game-card p-4">
              ...
              <p className="text-xs font-bold text-slate-700 dark:text-slate-300">Compete</p>
            </div>
          </div>
          <div className="text-center">
            <div className="game-card p-4">
              <User className="w-8 h-8 text-accent2 mx-auto mb-2" />
              <p className="text-xs font-bold text-slate-700 dark:text-slate-300">Collaborate</p>
            </div>
          </div>
          <div className="text-center">
            <div className="game-card p-4">
              <Trophy className="w-8 h-8 text-accent mx-auto mb-2" />
              <p className="text-xs font-bold text-slate-700 dark:text-slate-300">Level Up</p>
            </div>
          </div>
        </div>
      </div>
