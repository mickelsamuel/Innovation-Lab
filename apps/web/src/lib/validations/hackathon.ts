...
export const criterionSchema = z.object({
  ...
  maxScore: z.number().int().min(1, 'Max score must be at least 1').max(100, 'Max score cannot exceed 100'),
...
export const createHackathonSchema = z.object({
  ...
  description: z.string().min(50, 'Description must be at least 50 characters').max(10000).optional().or(z.literal('')),
